...
public class TesterRemoveFirst {
    public static void main(String[] args) {
        ...
        System.out.println("sebelum diremoveFirst");
        myLL.printAllInfo();
        System.out.println();

        Object objRemovedNodeInfo=myLL.removeFirst();
        System.out.println("setelah diremoveFirst");
        myLL.printAllInfo();
        System.out.println();
